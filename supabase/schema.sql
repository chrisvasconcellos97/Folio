...
-- ──────────────────────────────────────────────────────────────────────
-- Email Roundup Import — thread spine + event log
-- folio_email_threads: one row per subject line per account (deduped by subject_norm)
-- folio_thread_events: append-only timeline of each import pass
-- folio_tasks: source_thread_id + source columns to trace tasks back to emails
-- ──────────────────────────────────────────────────────────────────────
